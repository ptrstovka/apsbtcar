...
@ptrstovka
 Sign out
         Watch 8
         Star 32  Fork 45 coconauts/Arduino-Android-Bluetooth
         Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights
         Branch: master Find file Copy pathArduino-Android-Bluetooth/android/app/src/main/java/quadcopter/coconauts/net/quadcopter/Bluetooth.java
         2772bca  on Jan 6, 2015
@rephus rephus First commit
        1 contributor
        RawBlameHistory
        555 lines (484 sloc)  15.4 KB
/*
...
//            BluetoothDevice device = adapter.getRemoteDevice(address); // Get the BluetoothDevice object
            ...
            Log.e("err", "Unable to connect to the device", e);
        }
    }
